package pers.liyi.bullet.arms.widget;
...
public class CircleProgressBar extends View {
    ...
    public CircleProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttributes(context.obtainStyledAttributes(attrs, R.styleable.bulletArms_CircleProgressBar));
    }
    ...
    private void parseAttributes(TypedArray a) {
        barWidth = (int) a.getDimension(R.styleable.bulletArms_CircleProgressBar_cpb_barWidth, barWidth);
        rimWidth = (int) a.getDimension(R.styleable.bulletArms_CircleProgressBar_cpb_rimWidth, rimWidth);
        spinSpeed = a.getFloat(R.styleable.bulletArms_CircleProgressBar_cpb_spinSpeed, spinSpeed);
        barLength = (int) a.getDimension(R.styleable.bulletArms_CircleProgressBar_cpb_barLength, barLength);

        delayMillis = a.getInteger(R.styleable.bulletArms_CircleProgressBar_cpb_delayMillis, delayMillis);
        if (delayMillis < 0) {
            delayMillis = 10;
        }

        // Only set the text if it is explicitly defined
        if (a.hasValue(R.styleable.bulletArms_CircleProgressBar_cpb_text)) {
            setText(a.getString(R.styleable.bulletArms_CircleProgressBar_cpb_text));
        }

        barColor = a.getColor(R.styleable.bulletArms_CircleProgressBar_cpb_barColor, barColor);
        textColor = a.getColor(R.styleable.bulletArms_CircleProgressBar_cpb_textColor, textColor);
        rimColor = a.getColor(R.styleable.bulletArms_CircleProgressBar_cpb_rimColor, rimColor);
        circleColor = a.getColor(R.styleable.bulletArms_CircleProgressBar_cpb_circleColor, circleColor);
        contourColor = a.getColor(R.styleable.bulletArms_CircleProgressBar_cpb_contourColor, contourColor);

        textSize = (int) a.getDimension(R.styleable.bulletArms_CircleProgressBar_cpb_textSize, textSize);
        contourSize = a.getDimension(R.styleable.bulletArms_CircleProgressBar_cpb_contourSize, contourSize);
